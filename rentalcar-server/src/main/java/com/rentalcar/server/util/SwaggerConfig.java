...
/**
 * Swagger 2
 * Documetation Restful Services
 * hostname:port/v2/api-docs
...
public class SwaggerConfig {
    ...
    public static final Contact DEFAULT_CONTACT = new Contact("Reply", "www.reply.com", "apisupport@replay.com");
